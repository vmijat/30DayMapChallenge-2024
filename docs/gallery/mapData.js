const mapData = [
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/01-points-static.png',
        title: 'Day 01: Points',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/02-lines-kusttram-static-cropped.png',
        title: 'Day 02: Lines',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/03-polygons.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/04-hexagons.gif',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/05-journey-all-whales-dots.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/06-raster.png',
        title: 'Day 06: Raster',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/07-vintage.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/08-hdx.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/09-ai-only.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/10-pen-and-paper.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/11-arctic.png',
        title: 'Day 11: Arctic',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/13-a-new-tool-static.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/14-a-world-map.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/15-my-data.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/16-choropleth-processed.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/18-3d-processed.png',
        title: 'Day 18: 3D',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/19-typography.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/20-osm.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/21-conflict.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/22-2-colours.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/23-memory.png',
        title: 'Day 23: Memory',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/24-only-circular-shapes.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/25-heat.png',
        title: 'Day 25: Heat',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/26-map-projections-small.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/27-micromapping-static.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/28-the-blue-planet wider.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/29-overture.png',
    ...
    {
        src: 'https://github.com/bydata/30DayMapChallenge-2024/blob/main/plots/30-the-final-map.png',
